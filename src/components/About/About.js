  ...
  return (
    <div className={`${styles.about}`}>
      ...
      <div className={styles["container-2"]}>
        ...
        <p>
          I CONSIDER MYSELF CREATIVE AND GIVE A CONSIDERABLE AMOUNT OF ATTENTION TO DETAIL. I
          AM ABLE TO CRAFT WEBSITES THAT ARE BOTH FUNCTIONAL AND VISUALLY
          APPEALING WITH GREAT PROFICIENCY.
        </p>
        <p>
          I AM CONTINUOUSLY EXPERIMENTING WITH VARIOUS TOOLS AND TECHNIQUES WITH
